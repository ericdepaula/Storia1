...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  // Se ainda estivermos verificando o token no localStorage, mostramos um loading
  if (isLoading) {
    return (
      <div>
        <Loader2 className="w-10 h-10 text-blue-500 animate-spin mb-4" />
      </div>
    ); // Ou um componente de spinner
  }
  ...
  // Se houver token, renderiza a página protegida
  return children;
}
    ...
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          This is a placeholder page for password reset functionality.
        </p>
      </div>
      <div className="bg-white backdrop-blur-sm bg-opacity-95 rounded-2xl shadow-xl p-8 border border-gray-100">
        <p className="text-gray-700 mb-4">
          Em construção... Por enquanto, você pode voltar para a página de
          login.
        </p>
        <p className="text-gray-500 mb-4">
          Se você esqueceu sua senha, entre em contato com o suporte para
          assistência.
        </p>
        <a
          href="/signin"
